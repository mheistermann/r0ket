...
/* app for 2 r0kets: potentiometers attached to the hackerbus on one r0ket
 * control two digital output pins (e.g. LEDs) on the other.
 * just an experiment with a stupid protocol.
 */
