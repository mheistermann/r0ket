...
#define ETHER_BUFSIZE     1500

extern uint8_t ether_buf[ETHER_BUFSIZE];
extern uint16_t ether_len;
...
#define	ERXFCON_ANDOR	(uint8_t)(1<<6)
#define	ERXFCON_CRCEN	(uint8_t)(1<<5)
#define	ERXFCON_PMEN	(uint8_t)(1<<4)
#define	ERXFCON_MPEN	(uint8_t)(1<<3)
#define	ERXFCON_HTEN	(uint8_t)(1<<2)
#define	ERXFCON_MCEN	(uint8_t)(1<<1)
#define	ERXFCON_BCEN	(uint8_t)(1)
